...
// Watch for changes in selectedContacts and update form.recipients
watch(
    selectedContacts,
    (newValue) => {
...
const toggleAll = () => {
    if (selectedContacts.value.length === contacts.length) {
        selectedContacts.value = [];
    } else {
        selectedContacts.value = [...contacts.map((c: any) => c.id)];
    }
};
