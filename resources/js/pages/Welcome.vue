            ...
            >
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Manage your email campaigns efficiently with our
                        powerful yet simple platform. Create, send, and track
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span
                                        class="h-1.5 w-1.5 rounded-full bg-[#3b82f6] dark:bg-[#3E3E3A]"
                                    />
                                </span>
                            </span>
                            <span>
                                ...
                                <span
                                    v-else
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#3b82f6]"
                                >
                                    <span>Manage Contacts</span>
                                </span>
                            </span>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span
                                        class="h-1.5 w-1.5 rounded-full bg-[#10b981] dark:bg-[#3E3E3A]"
                                    />
                                </span>
                            </span>
                            <span>
                                ...
                                <span
                                    v-else
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#10b981]"
                                >
                                    <span>Create Campaigns</span>
                                </span>
                            </span>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span
                                        class="h-1.5 w-1.5 rounded-full bg-[#f59e0b] dark:bg-[#3E3E3A]"
                                    />
                                </span>
                            </span>
                            <span>
                                ...
                                <span
                                    v-else
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f59e0b]"
                                >
                                    <span>Track Performance</span>
                                </span>
                            </span>
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <Link
                                v-if="$page.props.auth.user"
                                :href="dashboard()"
                                class="inline-block rounded-sm border border-[#3b82f6] bg-[#3b82f6] px-5 py-1.5 text-sm leading-normal text-white hover:border-[#2563eb] hover:bg-[#2563eb] dark:border-[#60a5fa] dark:bg-[#60a5fa] dark:hover:border-[#3b82f6] dark:hover:bg-[#3b82f6]"
                            >
                                Go to Dashboard
                            </Link>
                            <Link
                        ...
                        <li v-if="canRegister && !$page.props.auth.user">
                            <Link
                                :href="register()"
                                class="inline-block rounded-sm border border-[#10b981] bg-[#10b981] px-5 py-1.5 text-sm leading-normal text-white hover:border-[#059669] hover:bg-[#059669] dark:border-[#34d399] dark:bg-[#34d399] dark:hover:border-[#10b981] dark:hover:bg-[#10b981]"
                            >
                                Sign Up Free
                            </Link>
                        </li>
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-gradient-to-br from-blue-50 to-indigo-100 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:from-blue-950 dark:to-indigo-900"
                >
                    <svg
                        class="w-full max-w-none translate-y-0 text-blue-600 opacity-100 transition-all duration-750 dark:text-blue-400 starting:translate-y-6 starting:opacity-0"
                        viewBox="0 0 438 280"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
